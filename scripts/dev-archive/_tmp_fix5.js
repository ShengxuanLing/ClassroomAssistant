...
// 13 exact keys: line trimmed starts with 'KEY':
...
for(const k of exactKeys){
  ...
  if(n!==2) console.log("!! exact "+JSON.stringify(k)+" n="+n);
}
// 3 long keys: match by prefix pattern  'K: ' with prefix of the key
const longPrefixes=["\u6b63\u5728\u5904\u7406\u672c\u5802\u6750\u6599","\u6709\u6750\u6599\u5904\u7406\u5931\u8d25","\u6ca1\u6709\u5904\u7406\u6b65\u9aa4\u53ef\u663e\u793a\u3002"];
for(const p of longPrefixes){
  let n=0;
  lines.forEach((l,i)=>{ if(i>=i18nS&&i<=i18nE){ const t=l.trim(); if(t.startsWith("\u0027"+p)&&/\u0027: /.test(t)&&!/\u0027: ['"\d]/.test(t.split("\u0027: ")[0])){n++; removeSet.add(i);} } });
  if(n!==2) console.log("!! long prefix "+JSON.stringify(p)+" n="+n);
}
